...
public class OBCBBilledAdapter1 extends RecyclerView.Adapter<OBCBBilledAdapter1.Approvals_ViewHolder> {
    private Context context;
    private ArrayList<Response> arrayList;
    private FunctionCall fcall=new FunctionCall();


    public OBCBBilledAdapter1(Context context, ArrayList<Response> arrayList) {
    ...
    public void onBindViewHolder(@NonNull Approvals_ViewHolder approvals_viewHolder, int i) {
        ...
        approvals_viewHolder.tv_tariff.setText(dashboard.getA2());
        approvals_viewHolder.tv_status.setText(dashboard.getA3());
        approvals_viewHolder.tv_installation.setText(dashboard.getA4());
        approvals_viewHolder.tv_billed_installations.setText(dashboard.getA5());
        approvals_viewHolder.tv_cons_units.setText(fcall.roundoff1(dashboard.getA6()));
        approvals_viewHolder.tv_billed_cons_units.setText(fcall.roundoff1(dashboard.getA7()));
        approvals_viewHolder.tv_opening_bal.setText(fcall.roundoff1(dashboard.getA8()));
        approvals_viewHolder.tv_demand.setText(fcall.roundoff1(dashboard.getA9()));
        approvals_viewHolder.tv_billed_demand.setText(fcall.roundoff1(dashboard.getA10()));
        approvals_viewHolder.tv_net_payable.setText(fcall.roundoff1(dashboard.getA11()));
        approvals_viewHolder.tv_coll_amt.setText(fcall.roundoff1(dashboard.getA12()));
        approvals_viewHolder.tv_cb.setText(fcall.roundoff1(dashboard.getA13()));
    }
    ...
    class Approvals_ViewHolder extends RecyclerView.ViewHolder {
        TextView tv_tariff, tv_installation, tv_status, tv_billed_installations, tv_cons_units, tv_billed_cons_units, tv_opening_bal,
                tv_demand, tv_billed_demand, tv_net_payable, tv_coll_amt, tv_cb ;
