...
public class OBCBUnBilledAdapter4 extends RecyclerView.Adapter<OBCBUnBilledAdapter4.Approvals_ViewHolder> {
    private Context context;
    private ArrayList<Response> arrayList;
    FunctionCall fcall = new FunctionCall();


    public OBCBUnBilledAdapter4(Context context, ArrayList<Response> arrayList) {
