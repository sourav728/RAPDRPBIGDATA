...
public class OBCBUnBilledAdapter2 extends RecyclerView.Adapter<OBCBUnBilledAdapter2.Approvals_ViewHolder> {
    ...
    public OBCBUnBilledAdapter2(Context context, ArrayList<Response> arrayList, String flag) {
    ...
    public void onBindViewHolder(@NonNull Approvals_ViewHolder approvals_viewHolder, int i) {
        ...
        if (flag.equals("N")) {
            approvals_viewHolder.tv_year.setText(dashboard.getA10());
        } else {
        ...
        approvals_viewHolder.tv_opening_bal.setText(fcall.roundoff1(dashboard.getA5()));
        approvals_viewHolder.tv_demand.setText(fcall.roundoff1(dashboard.getA6()));
        approvals_viewHolder.tv_billed_demand.setVisibility(View.GONE);
        approvals_viewHolder.tv_net_payable.setText(fcall.roundoff1(dashboard.getA7()));
        approvals_viewHolder.tv_coll_amt.setText(fcall.roundoff1(dashboard.getA8()));
        approvals_viewHolder.tv_cb.setText(fcall.roundoff1(dashboard.getA9()));
    }
