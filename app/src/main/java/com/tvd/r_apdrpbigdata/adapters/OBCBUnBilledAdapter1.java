...
public class OBCBUnBilledAdapter1 extends RecyclerView.Adapter<OBCBUnBilledAdapter1.Approvals_ViewHolder> {
    private Context context;
    private ArrayList<Response> arrayList;
    private FunctionCall fcall=new FunctionCall();


    public OBCBUnBilledAdapter1(Context context, ArrayList<Response> arrayList) {
...
//        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.WRAP_CONTENT));
    ...
    public void onBindViewHolder(@NonNull Approvals_ViewHolder approvals_viewHolder, int i) {
        ...
        approvals_viewHolder.tv_net_payable.setText(fcall.roundoff1(dashboard.getA8()));
        approvals_viewHolder.tv_coll_amt.setText(fcall.roundoff1(dashboard.getA9()));
        approvals_viewHolder.tv_cb.setText(fcall.roundoff1(dashboard.getA10()));
    }
    ...
    class Approvals_ViewHolder extends RecyclerView.ViewHolder {
        TextView tv_tariff, tv_installation, tv_status, tv_billed_installations, tv_cons_units, tv_billed_cons_units, tv_opening_bal, tv_demand, tv_billed_demand, tv_net_payable,
        tv_coll_amt, tv_cb ;
