...
public class Disconnection_summ_report_adapter extends RecyclerView.Adapter<Disconnection_summ_report_adapter.Holder>  {
    ArrayList<Billing_Summarization_model> arrayList;
    Context context;
    String date_check;
    public Disconnection_summ_report_adapter(ArrayList<Billing_Summarization_model> arrayList, Context context, String date_check_val) {
        this.arrayList = arrayList;
        this.context = context;
        this.date_check = date_check_val;
    }
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new Disconnection_summ_report_adapter.Holder(view);
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, int i) {
        ...
        holder.txt_connection_type.setText(arrayList.get(i).getConnecton_type());
    }
