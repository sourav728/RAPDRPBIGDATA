...
public class OBCBBilledAdapter2 extends RecyclerView.Adapter<OBCBBilledAdapter2.Approvals_ViewHolder> {
    private Context context;
    private ArrayList<Response> arrayList;
    private FunctionCall fcall=new FunctionCall();
    private String flag;

    public OBCBBilledAdapter2(Context context, ArrayList<Response> arrayList, String flag) {
    ...
    public void onBindViewHolder(@NonNull Approvals_ViewHolder approvals_viewHolder, int i) {
        ...
        if (flag.equals("N")){
            approvals_viewHolder.tv_year.setText(dashboard.getA13());
        }else {
            approvals_viewHolder.tv_year.setText(dashboard.getMonth());
        }
        approvals_viewHolder.tv_status.setText(dashboard.getA2());
        approvals_viewHolder.tv_installation.setText(dashboard.getA3());
        approvals_viewHolder.tv_billed_installations.setText(dashboard.getA4());
        approvals_viewHolder.tv_cons_units.setText(fcall.roundoff1(dashboard.getA5()));
        approvals_viewHolder.tv_billed_cons_units.setText(fcall.roundoff1(dashboard.getA6()));
        approvals_viewHolder.tv_opening_bal.setText(fcall.roundoff1(dashboard.getA7()));
        approvals_viewHolder.tv_demand.setText(fcall.roundoff1(dashboard.getA8()));
        approvals_viewHolder.tv_billed_demand.setText(fcall.roundoff1(dashboard.getA9()));
        approvals_viewHolder.tv_net_payable.setText(fcall.roundoff1(dashboard.getA10()));
        approvals_viewHolder.tv_coll_amt.setText(fcall.roundoff1(dashboard.getA11()));
        approvals_viewHolder.tv_cb.setText(fcall.roundoff1(dashboard.getA12()));
    }
