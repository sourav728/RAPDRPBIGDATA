...
public class OBCBUnBilledCustomer1 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    OBCBUnBilledAdapter1 obcbAdapter;
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case DIALOG_FAILURE:
                    progressDialog.dismiss();
                    functionCall.showtoast(OBCBUnBilledCustomer1.this, "No Data found");
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obcb_unbilled_customer1);
        initialization();
    ...
    public void initialization() {
        ...
        obcbAdapter = new OBCBUnBilledAdapter1(this, responseArrayList);
    ...
    public void submit() {
        ...
        value = "from="+date1+"&subDivision="+SUB_DIVISION+"&tariff="+TARIFF+"&acc_status="+STATUS+"&" +
                "company=500001%20-%20Hubli%20Electricity%20Supply%20Company%20Limited&zone="+ZONE+"&circle="+CIRCLE+"&division="+DIVISION;
        SendingData.OB_CB_Details9 ob_cb_details = sendingData.new OB_CB_Details9(handler, responseArrayList, value,obcbAdapter);
    ...
    private void barchart(ArrayList<Response> arrayList) {
        ...
        set5 = new BarDataSet(yaxis5, "BILLED DEMAND");
        set5.setColors(Color.YELLOW);
        set6 = new BarDataSet(yaxis6, "NET PAYABLE");
        set6.setColors(Color.CYAN);
        set7 = new BarDataSet(yaxis7, "COLLECTION AMOUNT");
        set7.setColors(Color.LTGRAY);
