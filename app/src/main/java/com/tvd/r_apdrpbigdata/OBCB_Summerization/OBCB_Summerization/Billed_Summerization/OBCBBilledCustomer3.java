...
public class OBCBBilledCustomer3 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    OBCBBilledAdapter3 obcbAdapter;
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case DIALOG_FAILURE:
                    progressDialog.dismiss();
                    functionCall.showtoast(OBCBBilledCustomer3.this, "No Data found");
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obcbbilled_customer3);
        initialization();
    ...
    public void initialization() {
        ...
        toolbar.setTitle("OB-CB Billed Customer Summarization Overall");
        ...
        obcbAdapter = new OBCBBilledAdapter3(this, responseArrayList, getsetValues.getMonth_flag());
    }
    ...
    public void submit() {
        ...
        value = "subDivision=" + SUB_DIVISION + "&acc_status=" + STATUS + "&company=500001%20-%20Hubli%20Electricity%20Supply%20Company%20Limited&zone="
                + ZONE + "&circle=" + CIRCLE + "&division=" + DIVISION + "&fromDate=" + FROM_DATE + "&toDate=" + TO_DATE;
        SendingData.OB_CB_Details7 ob_cb_details = sendingData.new OB_CB_Details7(handler, responseArrayList, value,obcbAdapter,getsetValues);
    ...
    private void barchart(ArrayList<Response> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            values8.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA9())));
            values9.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA10())));
            values10.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA11())));
        }
