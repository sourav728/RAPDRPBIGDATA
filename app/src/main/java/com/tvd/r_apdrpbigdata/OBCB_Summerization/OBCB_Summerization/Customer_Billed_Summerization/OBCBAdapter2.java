...
public class OBCBAdapter2 extends RecyclerView.Adapter<OBCBAdapter2.Approvals_ViewHolder> {
    private Context context;
    private ArrayList<Response> arrayList;
    private String flag;


    public OBCBAdapter2(Context context, ArrayList<Response> arrayList, String flag) {
