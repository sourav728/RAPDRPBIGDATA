...
public class OBCBUnBilledCustomer4 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    TextView tv_total1, tv_total2, tv_total3, tv_total4, tv_total5, tv_total6, tv_total7;
    Calendar mcalender;
    int day, month, year;
    ...
    OBCBUnBilledAdapter4 obcbAdapter;
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case DIALOG_FAILURE:
                    progressDialog.dismiss();
                    functionCall.showtoast(OBCBUnBilledCustomer4.this, "No Data found");
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obcb_unbilled_customer4);
        initialization();
    ...
    public void initialization() {
        ...
        obcbAdapter = new OBCBUnBilledAdapter4(this, responseArrayList);
    ...
    public void DateDialog1() {
        ...
        DatePickerDialog dpdialog1 = new DatePickerDialog(this, listener1, year, month, day);
    ...
    public void DateDialog2() {
        ...
        DatePickerDialog dpdialog2 = new DatePickerDialog(this, listener2, year, month, day);
        mcalender.add(Calendar.MONTH, -1);
        dpdialog2.show();
    }
    ...
    public void submit() {
        ...
        value = "from=" + date1 + "&subDivision=" + SUB_DIVISION + "&acc_status=" + STATUS + "&company=500001%20-%20Hubli%20Electricity%20Supply%20Company%20Limited" +
                "&zone=" + ZONE + "&circle=" + CIRCLE + "&division=" + DIVISION + "&to=" + date2;
        SendingData.OB_CB_Details12 ob_cb_details = sendingData.new OB_CB_Details12(handler, responseArrayList, value, obcbAdapter);
