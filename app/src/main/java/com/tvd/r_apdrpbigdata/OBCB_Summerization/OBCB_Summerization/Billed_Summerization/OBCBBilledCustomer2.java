...
public class OBCBBilledCustomer2 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    TextView tv_total1, tv_total2, tv_total3, tv_total4, tv_total5, tv_total6, tv_total7, tv_total8, tv_total9, tv_total10, tv_year;
    Calendar mcalender;
    int day, month, year;
    ...
    OBCBBilledAdapter2 obcbAdapter;
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case DIALOG_FAILURE:
                    progressDialog.dismiss();
                    functionCall.showtoast(OBCBBilledCustomer2.this, "No Data found");
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obcbbilled_customer2);
        initialization();
    ...
    public void initialization() {
        ...
        toolbar.setTitle("OB-CB Billed Customer Summarization Tariff-Wise");
        ...
        obcbAdapter = new OBCBBilledAdapter2(this, responseArrayList, getsetValues.getMonth_flag());
    }
    ...
    public void DateDialog1() {
        ...
        DatePickerDialog.OnDateSetListener listener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                date1 = String.valueOf(year);
                tv_from.setText(date1);
            }
        };
    ...
    public void submit() {
        ...
        value = "subDivision=" + SUB_DIVISION + "&tariff=" + TARIFF + "&acc_status=" + STATUS + "&company=500001%20-" +
                "%20Hubli%20Electricity%20Supply%20Company%20Limited&zone=" + ZONE + "&circle=" + CIRCLE + "&division=" + DIVISION + "&fromDate=" + date1 + "&toDate=" + date2;
        SendingData.OB_CB_Details6 ob_cb_details = sendingData.new OB_CB_Details6(handler, responseArrayList, value, obcbAdapter, getsetValues);
    ...
    private void barchart(ArrayList<Response> arrayList) {
        ...
        if (getsetValues.getMonth_flag().equals("N")){
            startYear = Integer.parseInt(arrayList.get(0).getA13());
            endYear = Integer.parseInt(arrayList.get(arrayList.size() - 1).getA13()) + 1;
        }else {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            values1.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA3())));
            values2.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA4())));
            values3.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA5())));
            values4.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA6())));
            values5.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA7())));
            values6.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA8())));
            values7.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA9())));
            values8.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA10())));
            values9.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA11())));
            values10.add(new BarEntry(i, Float.parseFloat(arrayList.get(i).getA12())));
        }
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            total1 = total1 + Double.parseDouble(arrayList.get(i).getA3());
            total2 = total2 + Double.parseDouble(arrayList.get(i).getA4());
            total3 = total3 + Double.parseDouble(arrayList.get(i).getA5());
            total4 = total4 + Double.parseDouble(arrayList.get(i).getA6());
            total5 = total5 + Double.parseDouble(arrayList.get(i).getA7());
            total6 = total6 + Double.parseDouble(arrayList.get(i).getA8());
            total7 = total7 + Double.parseDouble(arrayList.get(i).getA9());
            total8 = total8 + Double.parseDouble(arrayList.get(i).getA10());
            total9 = total9 + Double.parseDouble(arrayList.get(i).getA11());
            total10 = total10 + Double.parseDouble(arrayList.get(i).getA12());
        }
