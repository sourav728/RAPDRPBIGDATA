...
public class OBCBCustomer4 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case DIALOG_FAILURE:
                    progressDialog.dismiss();
                    functionCall.showtoast(OBCBCustomer4.this, "No Data found");
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obcbcustomer4);
        initialization();
    ...
    public void initialization() {
        ...
        toolbar.setTitle("OB-CB Customer Summarization Overall");
        ...
        obcbAdapter = new OBCBAdapter4(this, responseArrayList);
    ...
    public void submit() {
        ...
        value = "subDivision=" + SUB_DIVISION + "&acc_status=" + STATUS + "&from=" + FROM_DATE + "&to=" + TO_DATE + "" +
                "&company=500001%20-%20Hubli%20Electricity%20Supply%20Company%20Limited&zone=" + ZONE + "&circle=" + CIRCLE + "&division=" + DIVISION + "";
        SendingData.OB_CB_Details4 ob_cb_details = sendingData.new OB_CB_Details4(handler, responseArrayList, value, obcbAdapter, getsetValues);
