...
public class OBCBUnBilledCustomer2 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    OBCBUnBilledAdapter2 obcbAdapter;
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case DIALOG_FAILURE:
                    progressDialog.dismiss();
                    functionCall.showtoast(OBCBUnBilledCustomer2.this, "No Data found");
                    break;
    ...
    public void initialization() {
        ...
        toolbar.setTitle("OBCBUnbilledCustomer");
        ...
        obcbAdapter = new OBCBUnBilledAdapter2(this, responseArrayList, getsetValues.getMonth_flag());
    }
    ...
    private void populate_status_spinner() {
        ...
        for (int i = 0; i < getResources().getStringArray(R.array.account_status).length; i++) {
            ...
            if (value.equals("All")) {
                getSetValues.setCode("");
            } else getSetValues.setCode(value);
    ...
    public void submit() {
        ...
        value = "from=" + FROM_DATE + "&subDivision=" + SUB_DIVISION + "&tariff=" + TARIFF + "&acc_status=" + STATUS + "&company=500001%20-%20Hubli%20Electricity%20Supply%20Company%20Limited" +
                "&zone=" + ZONE + "&circle=" + CIRCLE + "&division=" + DIVISION + "&to=" + TO_DATE;
        SendingData.OB_CB_Details10 ob_cb_details = sendingData.new OB_CB_Details10(handler, responseArrayList, value, obcbAdapter, getsetValues);
    ...
    private void barchart(ArrayList<Response> arrayList) {
        ...
        if (getsetValues.getMonth_flag().equals("N")) {
            startYear = Integer.parseInt(arrayList.get(0).getA10());
            endYear = Integer.parseInt(arrayList.get(arrayList.size() - 1).getA10()) + 1;
        } else {
        ...
        for (int i = 0, j = 0; i < arrayList.size(); i++) {
            values1.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA3())));
            values2.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA4())));
            values3.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA5())));
            values4.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA6())));
            values5.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA7())));
            values6.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA8())));
            values7.add(new BarEntry(j++, Float.parseFloat(arrayList.get(i).getA9())));
        }
