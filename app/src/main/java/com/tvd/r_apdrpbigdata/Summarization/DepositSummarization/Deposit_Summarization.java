...
public class Deposit_Summarization extends AppCompatActivity implements  AdapterView.OnItemSelectedListener{
    ...
    int year;
    String COMPANY="", ZONE="", CIRCLE="", DIVISION="", SUB_DIVISION="", FROM_DATE, TO_DATE;
    ...
    Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what){
                case DEPOSIT_SUMMARIZATION_SUCCESS:
                    progressDialog.dismiss();
                    show_dialog(BILL_SUMMARIZATION_DIALOG);
                    Toast.makeText(getApplicationContext(),"Success",Toast.LENGTH_LONG).show();
                    break;
                case DEPOSIT_SUMMARIZATION_FAILURE:
                    progressDialog.dismiss();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deposit_summarization_layout);
        initialize();
        setspinner_values();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!from_edit.getText().toString().isEmpty()){
                    ...
                    sendingData.new Deposit_Summarization_value(handler,arrayList,"from="+FROM_DATE+"&to="+TO_DATE+"&subDivision="+SUB_DIVISION+"&company=500001%20-%20Hubli%20Electricity%20Supply%20Company%20Limited&zone="+ZONE+"&circle="+CIRCLE+"&division="+DIVISION,getSetValues).execute();
    ...
    private void initialize(){
        ...
        toolbar.setTitle("Deposit Summarization");
    ...
    public void showYearDialog(final boolean val) {
        final Dialog d = new Dialog(Deposit_Summarization.this);
            ...
            builder.setMessage("View Report")
                    ...
                    .setPositiveButton("Chart", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Deposit_Summarization.this, Deposit_Summarization_Chart.class);
                            Bundle bundle = new Bundle();
                            bundle.putSerializable("test", arrayList);
                            bundle.putString("DATE_CHECK", getSetValues.getDates_equal());
                            bundle.putString("appbarTitle", "Deposit_Summarization_Chart");
                    ...
                    .setNegativeButton("Report", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Deposit_Summarization.this, Deposit_Summarization_Report.class);
                            Bundle bundle = new Bundle();
                            bundle.putSerializable("test", arrayList);
                            bundle.putString("DATE_CHECK", getSetValues.getDates_equal());
                            bundle.putString("appbarTitle", "Deposit_Summarization_Report");
                            intent.putExtras(bundle);
                            startActivity(intent);
                        }
                    })
