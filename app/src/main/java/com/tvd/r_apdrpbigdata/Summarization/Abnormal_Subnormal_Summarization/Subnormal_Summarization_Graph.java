...
public class Subnormal_Summarization_Graph extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    Button submit;
    ...
    int year;
    ArrayList<Abnormal_Subnormal> abnormal_subnormals;
    ...
    Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what) {
                case SUBNORMAL_SUMMARIZATION_GRAPH_SUCCESS:
                    progressDialog.dismiss();
                    Toast.makeText(Subnormal_Summarization_Graph.this, "Success..", Toast.LENGTH_SHORT).show();
                    show_dialog(BILL_SUMMARIZATION_DIALOG);
                    break;
                case SUBNORMAL_SUMMARIZATION_GRAPH_FAILURE:
                    progressDialog.dismiss();
                    Toast.makeText(Subnormal_Summarization_Graph.this, "Failure!!", Toast.LENGTH_SHORT).show();
                    break;
            }
            return false;
        }
    ...
    public void initialize() {
        ...
        toolbar.setTitle("Subnormal Summarization");
        ...
        abnormal_subnormals = new ArrayList<>();
            ...
            builder.setMessage("View Report")
                    ...
                    .setPositiveButton("Chart", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Subnormal_Summarization_Graph.this, Abnormal_Summarization_Graph_Chart.class);
                            intent.putExtra("DATE_CHECK", getSetValues.getDates_equal());
                            intent.putExtra("ABNORMAL_SUBNORMAL","Subnormal");
                            intent.putExtra("mylist", abnormal_subnormals);
                            startActivity(intent);
                        }
                    })
                    .setNegativeButton("Report", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Subnormal_Summarization_Graph.this, Abnormal_Summarization_Graph_Report.class);
                            intent.putExtra("DATE_CHECK", getSetValues.getDates_equal());
                            intent.putExtra("ABNORMAL_SUBNORMAL","Subnormal");
                            intent.putExtra("mylist", abnormal_subnormals);
                            startActivity(intent);
    ...
    public void showYearDialog(final boolean val) {
        final Dialog d = new Dialog(Subnormal_Summarization_Graph.this);
                        ...
                        if (!TextUtils.isEmpty(sub_division)) {
                            if (!TextUtils.isEmpty(from_edit.getText().toString())) {
                                if (!TextUtils.isEmpty(to_edit.getText().toString())) {
                                    ...
                                    SendingData.Get_subnormal_summarization_graph_value get_subnormal_summarization_graph_value = sendingData.new Get_subnormal_summarization_graph_value(handler, abnormal_subnormals, getSetValues);
                                    get_subnormal_summarization_graph_value.execute(from_edit.getText().toString(), to_edit.getText().toString(), sub_division, company, zone, circle, division);
                                } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select To Date!!");
                            } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select From Date!!");
                        } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select Sub Division!!");
                    } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select Division!!");
                } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select Circle!!");
            } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select Zone!!");
        } else functionCall.setSnackBar(Subnormal_Summarization_Graph.this, root_layout, "Please select Escom!!");
    }
}
