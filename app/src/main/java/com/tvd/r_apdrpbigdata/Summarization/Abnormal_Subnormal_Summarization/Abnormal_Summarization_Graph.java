...
public class Abnormal_Summarization_Graph extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    Button submit;
    ...
    Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what) {
                case ABNORMAL_SUMMARIZATION_GRAPH_SUCCESS:
                    progressDialog.dismiss();
                    Toast.makeText(Abnormal_Summarization_Graph.this, "Success..", Toast.LENGTH_SHORT).show();
                    show_dialog(BILL_SUMMARIZATION_DIALOG);
                    break;
                case ABNORMAL_SUMMARIZATION_GRAPH_FAILURE:
                    progressDialog.dismiss();
                    Toast.makeText(Abnormal_Summarization_Graph.this, "Failure!!", Toast.LENGTH_SHORT).show();
                    break;
            }
            return false;
        }
    ...
    public void initialize() {
        ...
        toolbar.setTitle("Abnormal Summarization");
            ...
            builder.setMessage("View Report")
                    ...
                    .setPositiveButton("Chart", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Abnormal_Summarization_Graph.this, Abnormal_Summarization_Graph_Chart.class);
                            intent.putExtra("DATE_CHECK", getSetValues.getDates_equal());
                            intent.putExtra("mylist", abnormal_subnormals);
                            intent.putExtra("ABNORMAL_SUBNORMAL", "Abnormal");
                            startActivity(intent);
                        }
                    })
                    .setNegativeButton("Report", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Abnormal_Summarization_Graph.this, Abnormal_Summarization_Graph_Report.class);
                            intent.putExtra("DATE_CHECK", getSetValues.getDates_equal());
                            intent.putExtra("ABNORMAL_SUBNORMAL", "Abnormal");
                            intent.putExtra("mylist", abnormal_subnormals);
                            startActivity(intent);
    ...
    public void showYearDialog(final boolean val) {
        final Dialog d = new Dialog(Abnormal_Summarization_Graph.this);
                        ...
                        if (!TextUtils.isEmpty(sub_division)) {
                            if (!TextUtils.isEmpty(from_edit.getText().toString())) {
                                if (!TextUtils.isEmpty(to_edit.getText().toString())) {
                                    ...
                                    SendingData.Get_abnormal_summarization_graph_value get_abnormal_summarization_graph_value = sendingData.new Get_abnormal_summarization_graph_value(handler, abnormal_subnormals, getSetValues);
                                    get_abnormal_summarization_graph_value.execute(from_edit.getText().toString(), to_edit.getText().toString(), sub_division, company, zone, circle, division);
                                } else
                                    functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select To Date!!");
                            } else
                                functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select From Date!!");
                        } else
                            functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select Sub Division!!");
                    } else
                        functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select Division!!");
                } else
                    functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select Circle!!");
            } else
                functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select Zone!!");
        } else
            functionCall.setSnackBar(Abnormal_Summarization_Graph.this, root_layout, "Please select Escom!!");
    }
