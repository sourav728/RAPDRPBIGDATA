...
public class DisConnection_Summerization extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    Spinner spinner_escom, spinner_zone, spinner_circle, spinner_division, spinner_subdivision, spinner_connectiontype;

    Databasehelper databasehelper;
    FunctionCall functionCall;
    ArrayList<GetSetValues> company_list, zone_list, circle_list, division_list, subdivision_list, connectiontype_list;
    RoleAdapter1 company_adapter, zone_adapter, circle_adapter, division_adapter, subdivision_adapter , connectiontype_adapter;
    EditText from_edit, to_edit;
    int year;
    String COMPANY="", ZONE="", CIRCLE="", DIVISION="", SUB_DIVISION="", FROM_DATE, TO_DATE , CONNECTION_TYPE = "";
    ...
    Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what){
                case DISCONNECTION_SUMMARIZATION_SUCCESS:
                    progressDialog.dismiss();
                    Toast.makeText(getApplicationContext(),"Success",Toast.LENGTH_LONG).show();
                    show_dialog(BILL_SUMMARIZATION_DIALOG);

                    break;
                case DISCONNECTION_SUMMARIZATION_FAILURE:
                    progressDialog.dismiss();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_connection_summerization);
        initialize();
        setspinner_values();

        for (int i = 0; i < getResources().getStringArray(R.array.connection_type).length; i++) {
            getSet = new GetSetValues();
            getSet.setRole(getResources().getStringArray(R.array.connection_type)[i]);
            connectiontype_list.add(getSet);
            connectiontype_adapter.notifyDataSetChanged();
        }
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!from_edit.getText().toString().isEmpty()){
                    ...
                    String value = "from="+FROM_DATE+"&to="+TO_DATE+"&subDivision="+SUB_DIVISION+"&disconnect="+CONNECTION_TYPE +
                            "&company=500001%20" +
                            "-%20Hubli%20Electricity%20Supply%20Company%20Limited&zone="+ZONE+"&circle=" +CIRCLE+
                            "&division="+DIVISION;
                    setProgressDialog(progressDialog);
                    sendingData.new DisConnection_Summerization(handler,arrayList,value,getSet).execute();
    ...
    private void initialize(){
        ...
        toolbar.setTitle("Disconnection Summarization");
        ...
        spinner_connectiontype = findViewById(R.id.spr_connection_type);
        ...
        spinner_connectiontype.setOnItemSelectedListener(this);
        ...
        connectiontype_list = new ArrayList<>();
        connectiontype_adapter = new RoleAdapter1(connectiontype_list,getApplicationContext());
        spinner_connectiontype.setAdapter(connectiontype_adapter);
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int i, long id) {
        ...
        switch (parent.getId()){
            ...
            case R.id.spr_subdivision:
                ...
                break;
            case R.id.spr_connection_type:
                role = connectiontype_list.get(i);
                CONNECTION_TYPE = role.getRole();
                break;
        }
    }
    ...
    public void showYearDialog(final boolean val) {
        final Dialog d = new Dialog(DisConnection_Summerization.this);
                ...
                builder.setMessage("View Report")
                        ...
                        .setPositiveButton("Chart", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent intent = new Intent(DisConnection_Summerization.this, DisConnection_Summerization_chart.class);
                                Bundle bundle=new Bundle();
                                bundle.putSerializable("test",arrayList);
                                bundle.putString("appbarTitle","DisConnection_Summerization_chart");
                        ...
                        .setNegativeButton("Report", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent intent = new Intent(DisConnection_Summerization.this, Disconnection_Summerization_Report.class);
                                Bundle bundle=new Bundle();
                                bundle.putSerializable("test",arrayList);
